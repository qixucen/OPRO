...
MULTILINGUAL_QUESTION_DELIMITER = {
    ...
    "th": {
        "Q": "\u0e42\u0e08\u0e17\u0e22\u0e4c: ",
        "A": "\u0e04\u0e33\u0e15\u0e2d\u0e1a\u0e17\u0e35\u0e25\u0e30\u0e02\u0e31\u0e49\u0e19\u0e15\u0e2d\u0e19: ",  # pylint: disable=g-line-too-long
        "Direct A": "\u0e04\u0e33\u0e15\u0e2d\u0e1a\u0e17\u0e35: ",
    },
    "zh": {
        "Q": "\u95ee\u9898\uff1a",
...
for language in initial_keys:
    if language == "en":
        continue
    MULTILINGUAL_QUESTION_DELIMITER[f"{language}-en"] = MULTILINGUAL_QUESTION_DELIMITER[
        "en"
    ]
...
def get_normalized_prediction(
    ...
    *,
    ...
    DELIMITERS_FOR_ANSWER_AHEAD = (
        FINAL_ANSWER_AHEAD_PATTERNS  # pylint: disable=invalid-name
    )
    ...
    if not treat_as_bool:
        ...
        prediction_parsed_as_number = _parse_with_treating_as_number(prediction_parsed)
        if not any(
